...
namespace BMORPG_Server_Test
{
    ...
    /// <summary>
    ///This is a test class for EquipmentTest and is intended
    ///to contain all EquipmentTest Unit Tests
    ///</summary>
    [TestClass()]
    public class EquipmentTest
    {
        ...
        /// <summary>
        ///A test for Equipment Constructor
        ///</summary>
        [TestMethod()]
        public void EquipmentConstructorTest()
        {
            ...
            Equipment target = new Equipment(n, d, id);
